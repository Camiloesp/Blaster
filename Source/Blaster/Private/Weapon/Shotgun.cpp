...
void AShotgun::FireShotgun( const TArray<FVector_NetQuantize>& HitTargets )
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// calculate body shot damage by multiplying TimesHit x Damage - Store in DamageMap
		...
		// calculate head shot damage by multiplying TimesHit x headshot damage. - Store in DamageMap
